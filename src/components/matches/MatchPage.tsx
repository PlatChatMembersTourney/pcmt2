				...
				<div className="flex flex-col gap-4 max-w-185 md:w-185 min-w-0">
					...
					{match.streamLink && (
						<div className="mt-2 flex flex-col gap-2">
							<h2 className="text-red-400 uppercase font-bold text-[11px] ml-4 sm:ml-5 mb-1 leading-none">
								Stream
							</h2>
							{
								(typeof match.streamLink === 'string' ? [{
									"name": 'YouTube VOD',
									"link": match.streamLink
								}] : match.streamLink).map(({name, link}) => (
									<a
										href={link}
										target="_blank"
